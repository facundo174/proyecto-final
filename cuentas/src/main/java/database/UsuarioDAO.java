...
public Usuario getUserByPassword(String password) throws SQLException {
        PreparedStatement ps;
        ResultSet rs;
        Usuario u = null;

        ps = connection.prepareStatement("SELECT * FROM users WHERE password = ?");
...
public Usuario getUserByname(String name) throws SQLException {
 ...
 public Usuario getUserBylast_name(String last_name) throws SQLException {
        PreparedStatement ps;
        ResultSet rs;
        Usuario u = null;

        ps = connection.prepareStatement("SELECT * FROM users WHERE last_name = ?");
