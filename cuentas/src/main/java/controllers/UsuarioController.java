        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                case "/loginUser":
                    ...
                    response.sendRedirect("/cuentas/views/user.jsp");
                    break;
                ...
                case "/createUser":
                   ...
                   if(udao.getUserByUsername(username) != null){
                    ...
                    response.sendRedirect("/cuentas/views/new.jsp");
                    break;
                ...
                case "/viewUser":
                    ...
                    response.sendRedirect("/cuentas/views/edicion.jsp");
                    break;
                    ...
                    session.setAttribute("isLogin", false);
                    session.setAttribute("actualUsername", "");
                    response.sendRedirect("/cuentas/views/confirm.jsp");
                    break; 
               ...
               case "/updateUser":
                 ...
                 username = (String) session.getAttribute("actualUsername");
                   ...
                   if(udao.getUserByPassword(password)==null){
                    ...
                    regs_afectados = udao.updateUser(actualUser);}
                      ...
                      if(udao.getUserBylast_name(last_name)==null){
                    actualUser = new Usuario( username,password, name, last_name, email);
                    regs_afectados = udao.updateUser(actualUser);}
                ...
                session.setAttribute("actualUser", regs_afectados);
                     response.sendRedirect("/cuentas/views/changes.jsp");
